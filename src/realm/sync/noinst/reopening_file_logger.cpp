...
void ReopeningFileLogger::do_log(util::Logger::Level level, std::string const& message)
{
...
void ReopeningFileLogger::do_log_2(util::Logger::Level level, std::string const& message)
{
