...
protected:
    ...
    static void do_log(Logger&, Level, std::string const& message);

    virtual void do_log(Level, std::string const& message) = 0;
...
inline void Logger::do_log(Logger& logger, Level level, std::string const& message)
{
